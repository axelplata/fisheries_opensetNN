...
def wsvm(gamma, C, threshold,split=0, partition='val'):
    ...
    output_name = 'output_wsvm_open.csv'

    #WSVM
    test_command = './svm-predict -o -P ' + str(threshold) + ' ' + val_file + ' ' + model_basename + '_G'+str(gamma)+'_C'+str(C)+'_one_wsvm ' + output_name
...
wsvm(gamma, C, threshold, split, partition)
