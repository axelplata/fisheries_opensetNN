...
def wsvm(gamma, C, pval):
    ...
    #WSVM
    test_command ='./svm-predict -o  -P ' + str(pval) + ' ' + val_file + ' ' + models_dir + 'model_G'+str(gamma)+'_C'+str(C)+'_one_wsvm output_wsvm.csv'
