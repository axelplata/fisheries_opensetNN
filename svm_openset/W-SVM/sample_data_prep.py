import pandas as pd
df = pd.read_csv('./letter-recognition.csv',header = None) # importing test dataset
...
target_known_df.to_csv('./datasets/letters/train.csv',header = None, index = False)
test.to_csv('./datasets/letters/test.csv',header = None, index = False)
